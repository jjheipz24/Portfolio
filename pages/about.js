      ...
      <div className={styles.container}>
        <motion.div className={styles.left}
         ...
         transition={{ duration: 1.5 }}>
          ...
          />
          <p><b>Hobbies: </b> CrossFit, Running, Rugby, Gaming, Drumming, Singing</p>
        </motion.div>
        <motion.div className={styles.right}
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ delay: .5, duration: 1.5 }}>
          <p>Hi! My name is Jin Jin Heipler, and I’m from Shrewsbury, Massachusetts but am now living in Concord, Massachusetts. I recently graduated from the Rochester Institute of Technology with a Bachelor of Science in New Media Interactive Development and minors in Mobile Development and Communication.</p>
          <p>
            Ever since I was young, I knew I wanted to work with computers and code. My creative side, however, knew that I didn’t want to type boring, meaningless code. I wanted my projects to come alive. I was fascinated with and inspired by the games and other electronic devices I interacted with and how they were created, and I was constantly thinking of new things I could one day make.
          </p>
          <p>
